...
module.exports = bad = async (bad, bot) => {
    ...
    try {
        ...
        const username = bad.message.from.username ? bad.message.from.username : " 🦄 @DGXeon13 🇦🇱 V18ᯭ";
...
case 'runtime':{
    bad.deleteMessage().catch(() => {});
      reply(`━━━━━━━━━━━━━━━━━\n◉ 𝙷𝙴𝙻𝙻𝙾 ${pushname}\n━━━━━━━━━━━━━━━━━\n   🦄 @DGXeon13 🇦🇱 V18 𝚁𝚄𝙽𝚃𝙸𝙼𝙴   : ${runtime(process.uptime())}`)
    }
break;
case 'ping':{
let timestamp = speed()
let latensi = speed() - timestamp
    bad.deleteMessage().catch(() => {});
      reply(`━━━━━━━━━━━━━━━━━\n\◉ 𝙷𝙴𝙻𝙻𝙾 ${pushname}\n\━━━━━━━━━━━━━━━━━\n\◈ 🦄 @DGXeon13 🇦🇱 V18 𝚂𝙿𝙴𝙴𝙳   : ${latensi.toFixed(4)} 𝐌𝐒\n\━━━━━━━━━━━━━━━━━`)
    }
break;   
case 'owner': 
  let ownerText = 
  ...
  bad.replyWithPhoto(
    global.pp, 
    {
      ...
      reply_markup: {
        inline_keyboard: [
          [
            { text: '📲 CONTACT OWNER', url: 'https://t.me/kingbadboi' },

            { text: '📱 WhatsApp Channel', url: 'https://whatsapp.com/channel/0029VabAgz5rD9exU2F' }
          ],
        ]
      }
    }
